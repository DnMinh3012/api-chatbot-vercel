...
let writeDateToGoogleSheet = async (data) => {
    ...
    const serviceAccountAuth = new JWT({
        ...
        email: isValidJSON(process.env.GOOGLE_SERVICE_ACCOUNT_EMAIL) ? JSON.parse(process.env.GOOGLE_SERVICE_ACCOUNT_EMAIL) : process.env.GOOGLE_SERVICE_ACCOUNT_EMAIL,
        key: isValidJSON(process.env.GOOGLE_PRIVATE_KEY) ? JSON.parse(process.env.GOOGLE_PRIVATE_KEY) : process.env.GOOGLE_PRIVATE_KEY,
        scopes: [
